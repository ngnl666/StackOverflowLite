export default function Skeleton() {
	return (
		<>
			<div role="status" className="flex animate-pulse items-center space-x-2 md:space-x-8">
				...
				<div className="flex h-16 w-28 items-center justify-center rounded-full bg-gray-300">
					<svg
